...
void tacPrintSingle(TAC* tac) {
		...
		switch(tac->type) {
				...
				case TAC_LE: cerr << "TAC_LE ";	break;
				case TAC_GE: cerr << "TAC_GE ";	break;
				case TAC_EQ: cerr << "TAC_EQ ";	break;
				case TAC_NE: cerr << "TAC_NE ";	break;
				case TAC_AND: cerr << "TAC_AND ";	break;
				case TAC_OR: cerr << "TAC_OR ";	break;
				case TAC_ASS: cerr << "TAC_ASS ";	break;
				case TAC_POINTER_ASS: cerr << "TAC_POINTER_ASS  ";	break;
				...
				case TAC_POINTERDEC: cerr << "TAC_POINTERDEC "; break;
