    74,    75,    76,    77,    78,    79,
      80,    81,    82,    83,    25,    88,    23,    14,    25,    33,
      22,    23,    22,    25,    17,    18,    19,    20,    21,    22,
      27,    31,   105,    26,    27,    28,    29,    30,    24,   109,
      31,   111,   115,    17,    18,    19,    20,    21,    22,     3,
       4,    12,    26,    27,    28,    29,    30,    17,    18,    19,
      20,    21,    22,    13,    14,    32,    26,    27,    28,    29,
      30,    17,    18,    19,    20,    21,    22,    26,    24,    22,
      23,    27,    28,    29,    30,    17,    18,    19,    20,    21,
      22,    33,    24,    29,    30,    27,    28,    29,    30,    17,
      18,    19,    20,    21,    22,    12,    13,    14,    15,    27,
      28,    29,    30,    25,    20,    21,    22,    31,    25,    34,
      35,    27,    28,    29,    30,    27,    28,    29,    30,    25,
      12,    34,    31,     6,    26,    22,     7,     5,    27,    33,
      26,    66,    73,    40,   113
};
...
static const yytype_int8 yystos[] =
{
      ...
      10,    11,    12,    48,    49,    50,    47,    40,    40,    31,
      25,    25,    12,    12,    13,    14,    15,    25,    51,    53,
      56,    56,    22,    23,    50,    34,    31,    56,    56,    23,
      25,    56,    52,    53,    17,    18,    19,    20,    21,    22,
      27,    28,    29,    30,    56,    56,    49,    26,    26,    56,
      54,    56,    26,    52,    56,    56,    56,    56,    56,    56,
      56,    56,    56,    56,    24,     6,    50,    24,    26,    32,
      55,    22,    50,    56,    56,     7,    55,    50
};
...
#line 77 "parser.y"
                                                              { //astPrint($1, 0); 
                                                                ...
                                                                checkUndeclarations();
                                                                checkDeclarationUsage((yyvsp[0].ast));
                                                                }
#line 1302 "y.tab.c"
    break;
...
#line 1506 "y.tab.c"
  ...
  case 37: /* lprint: printelement printrest  */
#line 157 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_PRINT_ARG,0,(yyvsp[-1].ast),(yyvsp[0].ast),0,0); }
#line 1512 "y.tab.c"
    break;

  case 38: /* printrest: printelement printrest  */
#line 161 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_PRINT_ARG,0,(yyvsp[-1].ast),(yyvsp[0].ast),0,0); }
#line 1518 "y.tab.c"
    break;

  case 39: /* printrest: %empty  */
#line 162 "parser.y"
                                                              { (yyval.ast) = 0; }
#line 1524 "y.tab.c"
    break;

  case 40: /* printelement: expr  */
#line 165 "parser.y"
                                                              { (yyval.ast) = (yyvsp[0].ast); }
#line 1530 "y.tab.c"
    break;

  case 41: /* printelement: LIT_STRING  */
#line 166 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_SYMBOL,(yyvsp[0].symbol),0,0,0,0); }
#line 1536 "y.tab.c"
    break;

  case 42: /* lparam: expr lparamrest  */
#line 170 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_PARAML,0,(yyvsp[-1].ast),(yyvsp[0].ast),0,0); }
#line 1542 "y.tab.c"
    break;

  case 43: /* lparam: %empty  */
#line 171 "parser.y"
                                                              { (yyval.ast) = 0; }
#line 1548 "y.tab.c"
    break;

  case 44: /* lparamrest: ',' expr lparamrest  */
#line 175 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_PARAML,0,(yyvsp[-1].ast),(yyvsp[0].ast),0,0); }
#line 1554 "y.tab.c"
    break;

  case 45: /* lparamrest: %empty  */
#line 176 "parser.y"
                                                              { (yyval.ast) = 0; }
#line 1560 "y.tab.c"
    break;

  case 46: /* expr: TK_IDENTIFIER  */
#line 180 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_SYMBOL,(yyvsp[0].symbol),0,0,0,0); }
#line 1566 "y.tab.c"
    break;
...
#line 1644 "y.tab.c"
  ...
  case 60: /* expr: TK_IDENTIFIER '(' lparam ')'  */
#line 194 "parser.y"
                                                              { (yyval.ast) = astCreate(AST_FUNCALL,(yyvsp[-3].symbol),(yyvsp[-1].ast),0,0,0); }
#line 1650 "y.tab.c"
    break;

  case 61: /* expr: TK_IDENTIFIER '[' expr ']'  */
#line 195 "parser.y"
